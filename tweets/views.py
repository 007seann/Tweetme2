...
def tweet_delete_view(request, tweet_id, *args, **kwargs):
  ...
  if not qs.exists():
    return Response({"messages": "You cannot delete this tweet"}, status=401)
  obj = qs.first()
  obj.delete()
...
def tweet_create_view_pure_django(request, *args, **kwargs):
  '''
  REST API Create View -> DRF(Django RestFramework)
  '''
  user = request.user
...
def tweet_datail_view_pure_django(request, tweet_id, *args, **kwargs):
  """
  REST API VIEW
  Consumed by JavaScript or Swift/Java/iOS/Android
  return json data
